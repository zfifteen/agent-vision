...
`/codex-vision roast` starts the camera, returns one JPEG frame into the chat, stops the camera, and asks Codex to write one opt-in playful roast of 400 characters or fewer from visible non-sensitive details.
